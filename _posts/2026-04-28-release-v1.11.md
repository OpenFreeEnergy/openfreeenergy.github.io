...
**openfe** can now perform simulations of proteins in membranes. These simulations require additional preparation: the user must supply a fully built, solvated, pre-equilibrated system, prepared with an external package. See the new [tutorial] on RBFE Calculations of Protein-Membrane Sytems for guidance.
